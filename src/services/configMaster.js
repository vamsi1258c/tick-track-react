...
export const fetchConfigMaster = async () => {
  try {
    ...
    throw (
      error.response?.data || 'An error occurred while fetching config master'
    );
  }
};
...
export const fetchConfigMasterById = async (configId) => {
  try {
    ...
    throw (
      error.response?.data ||
      'An error occurred while fetching the config master entry'
    );
  }
};
...
export const createConfigMaster = async (configData) => {
  try {
    ...
    throw (
      error.response?.data ||
      'An error occurred while creating the config entry'
    );
  }
};
...
export const updateConfigMaster = async (configId, configData) => {
  try {
    ...
    throw (
      error.response?.data ||
      'An error occurred while updating the config master entry'
    );
  }
};
...
export const deleteConfigMaster = async (configId) => {
  try {
    ...
    throw (
      error.response?.data ||
      'An error occurred while deleting the config master entry'
    );
  }
};
