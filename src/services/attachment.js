...
export const fetchAttachments = async (ticketId) => {
  try {
    ...
    throw (
      error.response?.data || 'An error occurred while fetching attachments'
    );
  }
};
...
export const fetchAttachment = async (ticketId, attachmentId) => {
  try {
    ...
    throw (
      error.response?.data || 'An error occurred while fetching the attachment'
    );
  }
};
...
export const uploadAttachment = async (ticketId, attachment) => {
  ...
  try {
    ...
    const fileUploadResponse = await api.post(
      `/ticket/${ticketId}/attachments/${attachmentId}/upload`,
      formData,
      {
        headers: {
    ...
    throw (
      error.response?.data || 'An error occurred while uploading the attachment'
    );
  }
};
...
export const updateAttachment = async (
  ...
  try {
    ...
    throw (
      error.response?.data || 'An error occurred while updating the attachment'
    );
  }
};
...
export const deleteAttachment = async (ticketId, attachmentId) => {
  try {
    ...
    throw (
      error.response?.data || 'An error occurred while deleting the attachment'
    );
  }
};
...
export const downloadAttachment = async (ticketId, attachmentId) => {
  try {
    const response = await api.get(
      `/ticket/${ticketId}/attachments/${attachmentId}/download`,
      {
