        ...
        {selectedUser && (
          <div>
            ...
            <Accordion defaultExpanded>
              ...
              <AccordionDetails>
                <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                  {selectedUser.tickets_created &&
                  selectedUser.tickets_created.length > 0 ? (
            ...
            <Accordion defaultExpanded>
              ...
              <AccordionDetails>
                <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                  {selectedUser.tickets_assigned &&
                  selectedUser.tickets_assigned.length > 0 ? (
                    <Table sx={{ minWidth: 650 }}>
                      <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                        <TableRow>
                          <TableCell sx={{ fontWeight: 'bold' }}>
            ...
            {selectedUser.approver && (
              <Accordion defaultExpanded>
                ...
                <AccordionDetails>
                  <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                    {selectedUser.tickets_approved &&
                    selectedUser.tickets_approved.length > 0 ? (
                      <Table sx={{ minWidth: 650 }}>
                        <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                          <TableRow>
                            <TableCell sx={{ fontWeight: 'bold' }}>
            ...
            <Paper
              sx={{ padding: 3, marginTop: 3, backgroundColor: '#f9f9f9' }}
            >
              <Typography variant="h6" sx={{ marginBottom: 1 }}>
                Activity:
              </Typography>
              {selectedUser.activity_logs &&
              selectedUser.activity_logs.length > 0 ? (
                <ul>
