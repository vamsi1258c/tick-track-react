    ...
    <div style={{ padding: '20px' }}>
      <Card sx={{ maxWidth: 800, margin: 'auto', mb: 4 }}>
        ...
        <CardContent>
          {user && (
            <div>
              ...
              <Typography variant="body1" sx={{ mb: 2 }}>
                ...
                {user.tickets_assigned.length}
              </Typography>
              <Typography variant="body1" sx={{ mb: 2 }}>
                <strong>Tickets Approved:</strong>{' '}
                {user.tickets_approved.length}
              </Typography>
          ...
          {isEditing && <Typography>Editing user details...</Typography>}{' '}
          {/* Optional editing message */}
        </CardContent>
      </Card>
    </div>
  )
