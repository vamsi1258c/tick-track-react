    ...
    useEffect(() => {
        const fetchAllData = async () => {
            try {
                ...
                const initialCategory = ticketResponse.data.category || 'service'; // Default to 'service' if not set
                setSubcategories(getSubcategories(initialCategory)); // Load subcategories based on current category
