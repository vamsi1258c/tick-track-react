...
export const renderStatusBadge = (status) => {
    switch (status?.toLowerCase()) {
        ...
        case 'in_progress':
            return <Chip label="In Progress" color="primary" size="small" sx={chipStyles} />;
        case 'closed':
            return <Chip label="Closed" color="secondary" size="small" sx={chipStyles} />;
        case 'resolved':
            return <Chip label="Resolved" color="success" size="small" sx={chipStyles} />;
        case 'to_be_approved':
            return (
                <Chip
